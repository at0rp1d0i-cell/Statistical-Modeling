...
- 已新增 `docs/paper/03_manuscript_v0_2.md`。
- v0.2 将当前证据链整合为更接近正式参赛论文的结构：
  - 摘要与关键词
  - 引言
  - 文献综述与理论背景
  - 理论机制与研究假设
...
- `03_manuscript_v0_2.md` 是当前最完整正文底稿，可用于内部评审和答辩结构演练。
- 它仍不是最终提交稿；正式提交前需补齐参考文献格式、图表排版、AI 使用说明、数据代码包说明和必要的最终重跑。
- 政策文本部分仍按 `Table 13 not_ready` 写作，不把 LLM 模块写成已验证机制结论。
